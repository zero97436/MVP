...
# Enregistrement des routers Community sous /api.
for module in (auth, hosts, checks, dashboard, metrics, users, admin, ai, agent, maintenance, events, discovery, bam, tickets, apm, docker, check_templates, public_status, search, migrate, branding, knowledge, roles, settings_routes):
    app.include_router(module.router, prefix=settings.API_PREFIX)

# Modules payants (routers + middleware d'audit) : présents uniquement dans
# l'édition Enterprise. Absents -> édition Community, rien ne change.
