#!/usr/bin/env python3
"""Agent de collecte minimal pour Orbisys.
...
def main() -> None:
    p = argparse.ArgumentParser(description="Orbisys metric agent")
    p.add_argument("--url", required=True, help="URL de l'endpoint /api/metrics/ingest")
    p.add_argument("--host-id", type=int, help="ID de l'hôte côté Orbisys")
